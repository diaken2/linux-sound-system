...
export function CheckBox(props: {
  ...
  return (
    <label data-tip={tooltip} className="checkbox-area" style={style}>
      <input
        type="checkbox"
        data-tip={tooltip}
        checked={checked}
...
export function MdiButton(props: {
  ...
  return (
    ...
    >
      <Icon
        path={icon}
        size={buttonSize === "tiny" ? "15px" : "24px"}
        style={rot}
      />
    </div>
  );
...
export function MdiIcon(props: {
  ...
  return (
    <span data-tip={props.tooltip} style={props.style}>
...
export function ErrorMessage(props: { message?: string }) {
  return props.message ? (
    <div style={{ color: "var(--error-text-color)", whiteSpace: "pre-wrap" }}>
      {props.message}
    </div>
  ) : null;
}
...
export function add_default_option<OPTION extends string>(
  options: OPTION[],
  defaultValue: string
): void {
...
export function EnumInput<OPTION extends string>(props: {
  ...
  if (!Object.keys(optionsMap).includes(value)) optionsMap[value] = value;
  return (
    <select
      id={props.desc}
      name={props.desc}
      ...
      style={props.style}
      className={
        value === "default" ? props.className + "-default" : props.className
      }
    >
  ...
  return (
    <>
      <OptionLine desc={props.desc} data-tip={props["data-tip"]}>
        <OptionalTextInput
          placeholder={
            props.placeholder === undefined ? "default" : props.placeholder
          }
          className="setting-input"
          value={props.value}
          data-tip={props["data-tip"]}
