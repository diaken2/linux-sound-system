      ...
      <>
        ...
        >
          <TabList>
            ...
            <Tab>
              Devices{" "}
              {errors({ path: ["devices"], includeChildren: true }) && (
                <ErrorIcon />
              )}
            </Tab>
            <Tab>
              Filters{" "}
              {errors({ path: ["filters"], includeChildren: true }) && (
                <ErrorIcon />
              )}
            </Tab>
            <Tab>
              Mixers{" "}
              {errors({ path: ["mixers"], includeChildren: true }) && (
                <ErrorIcon />
              )}
            </Tab>
            <Tab>
              Processors{" "}
              {errors({ path: ["processors"], includeChildren: true }) && (
                <ErrorIcon />
              )}
            </Tab>
            <Tab>
              Pipeline{" "}
              {errors({ path: ["pipeline"], includeChildren: true }) && (
                <ErrorIcon />
              )}
            </Tab>
            <Tab>Files</Tab>
            <Tab>Shortcuts</Tab>
            <Tab>Channel Gain setup</Tab>
          </TabList>
          <TabPanel />
          <TabPanel>
